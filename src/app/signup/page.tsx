    ...
    <div className="min-h-screen flex items-center justify-center bg-lavender-50 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-lavender-900 font-display">Hemen başla</h1>
          <p className="text-lavender-600 mt-2 text-sm">Dijital avatarını oluştur, kıyafetleri dene</p>
        </div>
        ...
        <p className="text-center text-sm text-lavender-600 mt-6">
          ...
          <Link href="/login" className="font-semibold text-lavender-700 hover:underline">
            Giriş yap
          </Link>
        </p>
      </div>
